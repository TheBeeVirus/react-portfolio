        ...
        <section id="contact" className="d-flex min-vh-100">
            <div className="container py-2">
                <div class="row">
                    ...
                    <a href="https://github.com/TheBeeVirus" className="col-3 text-center fs-1" target="_blank" rel="noreferrer"><i class="fab fa-github"></i></a>
                    <a href="https://discordapp.com/users/TheBeeVirus#9177/" className="col-3 text-center fs-1" target="_blank" rel="noreferrer"><i class="fab fa-discord"></i></a> 
                </div>
            </div>
        </section>
    )
